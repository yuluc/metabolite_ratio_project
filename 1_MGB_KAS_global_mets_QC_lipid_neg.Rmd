...
fig_dir <- "/figures/1_global_mets_QC/lipid_neg/"
post_qc_dir <- "/udd/reyul/mets_ratio_CodeReview/data/PEGASUS/1_global_mets_post_qc/lipid_neg/"
...
save(samp_dat_final, samp_mets_cols, mets_info, samp_na, samp_dat_origscale, 
     file = str_c(post_qc_dir, "processed_lipid_neg_halfmin.RData"))
